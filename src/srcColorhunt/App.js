...
class Colorhunt extends Component {
  ...
  handlePointerEnter = (event) => {
    if(event.target.style.backgroundColor.toUpperCase() !== this.state.color){
      ...
      var time = timeElement[0].innerHTML;
      ...
      <div className="AppColorhunt">
        ...
        {lose
          ...
          <div className="results">
            ...
            <HighScoreInput pts={points} onStored={this.displayHallOfFame} /><HallOfFame entries={hallOfFame}/>
          ...
          <div className="gameOn">
            ...
            <header className="App-header">
              ...
              <span className="color" style={{color:colorSet[Math.floor(Math.random()*3)]}}>{color}</span>
              <span className="score">{score}</span>
            </header>
            <div className="App-board">
              <span className="targ first" onPointerEnter={this.handlePointerEnter} style={style[0]}></span>
              <span className="targ second" onPointerEnter={this.handlePointerEnter} style={style[1]}></span>
              <span className="targ third" onPointerEnter={this.handlePointerEnter} style={style[2]}></span>
            </div>
          </div>
        }
      </div>
